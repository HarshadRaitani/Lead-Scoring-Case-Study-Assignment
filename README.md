...
- Lead Scoring Case Study Notebook.ipynb : The python notebook with coding, data analysis and model building
- Assignment subjective solutions.pdf : Some subjective questions answered
- Lead Scoring Case Study.pptx: Final Presentation
- Lead score assignment Summary.pdf : Summary on what's done in the entire python notebook 
